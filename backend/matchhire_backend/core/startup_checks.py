...
def validate_startup_configuration() -> None:
    ...
    # Check JWT settings
    jwt_settings_exist = all([
        get_env("JWT_ACCESS_COOKIE_NAME", default=""),
        get_env("JWT_REFRESH_COOKIE_NAME", default=""),
    ])
    if not jwt_settings_exist:
        errors.append("JWT settings are not properly configured")
