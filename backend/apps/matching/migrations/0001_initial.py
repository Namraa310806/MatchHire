    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["candidate"], name="job_matches_candida_aeb8ad_idx"
                    ),
                    models.Index(fields=["job"], name="job_matches_job_id_3ba270_idx"),
                    models.Index(
                        fields=["match_score"], name="job_matches_match_s_c4667a_idx"
                    ),
                ],
                "constraints": [
